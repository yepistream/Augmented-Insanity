                                           ...
                                           XrExtensionProperties *properties)
{
	...
	// TODO(aug-ins): module-advertised extensions require an IPC-level solution
	// (xrEnumerateInstanceExtensionProperties is client-side; modules live in the service process).
