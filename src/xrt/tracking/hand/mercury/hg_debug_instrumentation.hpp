...
struct hg_tuneable_values
{
	...
	struct u_var_draggable_f32 min_keypoint_presence_confidence;
	struct u_var_draggable_f32 min_reacquire_detection_confidence;
	struct u_var_draggable_f32 output_filter_fc_min;
	struct u_var_draggable_f32 output_filter_fc_min_d;
	struct u_var_draggable_f32 output_filter_beta;
