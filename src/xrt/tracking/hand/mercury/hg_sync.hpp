...
enum mono_hand_tracking_state : int32_t
{
	MONO_HAND_STATE_UNTRACKED = 0,
	MONO_HAND_STATE_TENTATIVE = 1,
	MONO_HAND_STATE_TRACKED = 2,
	MONO_HAND_STATE_DEGRADED = 3,
};

enum mono_detector_refresh_reason : int32_t
{
	MONO_DETECTOR_REFRESH_NONE = 0,
	MONO_DETECTOR_REFRESH_UNTRACKED = 1,
	MONO_DETECTOR_REFRESH_TENTATIVE = 2,
	MONO_DETECTOR_REFRESH_DEGRADED = 3,
	MONO_DETECTOR_REFRESH_PERIODIC = 4,
	MONO_DETECTOR_REFRESH_OVERLAP = 5,
	MONO_DETECTOR_REFRESH_ALWAYS = 6,
};
...
struct mono_hand_output_filters
{
	struct m_filter_euro_vec3 positions[XRT_HAND_JOINT_COUNT] = {};
	struct m_filter_euro_quat orientations[XRT_HAND_JOINT_COUNT] = {};
};
...
public:
	...
	struct hand_region_of_interest last_good_rois[2][2] = {};
	struct xrt_hand_joint_set last_good_outputs[2] = {};
	bool have_last_good_output[2] = {false, false};
	struct mono_hand_output_filters output_filters[2] = {};
	int32_t mono_hand_state[2] = {MONO_HAND_STATE_UNTRACKED, MONO_HAND_STATE_UNTRACKED};
	int32_t mono_detector_refresh_reason[2] = {MONO_DETECTOR_REFRESH_NONE, MONO_DETECTOR_REFRESH_NONE};
	int32_t mono_bad_frame_count[2] = {0, 0};
	int32_t mono_overlap_frame_count[2] = {0, 0};
	int32_t mono_frames_since_detection_refresh[2] = {0, 0};
	int32_t mono_good_measurement_streak[2] = {0, 0};
	int32_t mono_raw_active[2] = {0, 0};
	int32_t mono_filtered_active[2] = {0, 0};
	bool mono_overlap_quarantine_active[2] = {false, false};
	bool mono_cached_output_used[2] = {false, false};
	float mono_optimized_hand_size[2] = {STANDARD_HAND_SIZE, STANDARD_HAND_SIZE};
	float mono_last_reprojection_error[2] = {0.0f, 0.0f};
	float mono_effective_depth_weight[2] = {0.0f, 0.0f};
	...
	float configured_hand_size = STANDARD_HAND_SIZE;
	bool lock_hand_size = false;
